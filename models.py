...
class Election(Base):
    ...
    ElectionStart = Column(DateTime(timezone=True))
    ElectionEnd = Column(DateTime(timezone=True))
    CoCFilingStart = Column(DateTime(timezone=True))
    CoCFilingEnd = Column(DateTime(timezone=True))
    CampaignStart = Column(DateTime(timezone=True))
    CampaignEnd = Column(DateTime(timezone=True))
    VotingStart = Column(DateTime(timezone=True))
    VotingEnd = Column(DateTime(timezone=True))
    AppealStart = Column(DateTime(timezone=True))
    AppealEnd = Column(DateTime(timezone=True))
...
class Code(Base):
    ...
    CodeExpirationDate = Column(DateTime(timezone=True))
    created_at = Column(DateTime(timezone=True), server_default=func.now())
    updated_at = Column(DateTime(timezone=True), onupdate=func.now())
